...
module Polynomial = struct 
  include Types_generated.Polynomial
  include Ctypes_bindings.Function.Polynomial

  let roots_isolate polynome assignment roots roots_size = roots_isolate polynome assignment roots roots_size 
end 
