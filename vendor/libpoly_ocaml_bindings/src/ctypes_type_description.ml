...
module Assignment = struct
  ...
  type t = [ `lp_assignment_t ] structure

  let s : t typ = structure ""
  let t = typedef s "lp_assignment_t"

end

module Value  = struct

  type t = [ `lp_value_t ] structure

  let s : t typ = structure ""
  let t = typedef s "lp_value_t"
...
module Types (F : TYPE) = struct
  ...
  module Polynomial_context = struct

    type t = [ `lp_polynomial_context_struct ] structure

    let s : t typ = structure ""
    let t = typedef s "lp_polynomial_context_t"
  ...
  module Polynomial = struct
    ...
    (* Anonymous lp_polynomial_t *)

    type t = [ `lp_polynomial_struct ] structure

    let s : t typ = structure ""
    let t = typedef s "lp_polynomial_t"
